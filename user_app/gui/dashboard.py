...
class StatCard(QFrame):
    def __init__(self, title, value, icon_text, bg_icon, fg_icon, parent=None):
        ...
        self.lbl_val.setFont(QFont("Segoe UI", 20, QFont.Bold))
...
class DashboardScreen(QWidget):
    ...
    def refresh(self):
        try:
            ...
            from core.utils.helpers import format_date, format_currency
...
class PlaceholderScreen(QWidget):
    def __init__(self, title, desc="Đang xây dựng...", parent=None):
        ...
        lbl_t = QLabel(title)
        lbl_t.setFont(QFont("Segoe UI", 18, QFont.Bold))
...
class DashboardWindow(QWidget):
    ...
    def _build_ui(self):
        ...
        from user_app.gui.book_gui import BookWindow
        self.screens = {
    ...
    def _show_page(self, key: str):
        ...
        if key == "dashboard":
            ...
            try:
                from core.services.borrow_service import get_dashboard_stats
                stats = get_dashboard_stats()
